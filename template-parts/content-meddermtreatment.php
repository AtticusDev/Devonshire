			...
			<div class="container mt-5">
				<div class="row">
					<div class="col-md-8 text-left">
						<h1>Specialist Acne Treatment</h1>
						<p>The most effective acne solution for you and your skin.<br />
						• We are specialists who have successfully treated acne for over 20 years.<br />
• Our acne treatments are tailored to your specific skin type.<br />
• Our treatments are proven to achieve results.</p>

<h2>Acne</h2>
<p>Acne is a skin condition that affects millions of people. The most common form is called Acne Vulgaris and
presents with blackheads, whiteheads and other types of pimples on the skin. Although the face and neck are
the main areas affected, acne can also occur on the back and chest. Acne usually starts at puberty with around
80% of people between 11 and 30 affected at some point. Some continue to have recurring episodes and are at
risk of acne scars.</p>
<p>There is a common misconception that acne is difficult to treat. In fact, effective acne treatments can make a
significant difference and improve the long-term health and condition of your skin. If you are seeking private
acne treatment, our consultants offer a full assessment and a more in-depth analysis of your skin than a typical
skin clinic. They can devise a highly effective course of acne treatments designed specifically for you.</p>
	...
	<div class="container-fluid">
		<div class="row">
			<div class="container">
				<div class="row">
					<div class="col-md-6 p-5 animation-element fade-up text-left">
						<h2 class="gold">Acne treatments</h2>
					...
					<div class="col-md-6 p-5 animation-element fade-up text-left">
						<h2 class="gold">Treatment consultations</h2>
						<p>“I was so pleased to get the call that I could finally have my treatment. The team that took care of me were fabulous and made me feel really comfortable.Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus faucibus velit ac lorem sollicitudin rutrum. ”</p>
					</div>
				</div>
			</div>
